      ...
      <div className="container-wide">
        ...
        <div className="flex flex-wrap justify-start mb-8">
          <Button
            ...
            className={`m-1 text-xl ${activeTab === 'sectors' ? 'bg-qatari hover:bg-qatari-light' : 'border-qatari text-qatari hover:bg-qatari/10'}`}
          ...
          <Button
            ...
            className={`m-1 text-xl ${activeTab === 'growth' ? 'bg-qatari hover:bg-qatari-light' : 'border-qatari text-qatari hover:bg-qatari/10'}`}
          ...
          <Button
            ...
            className={`m-1 text-xl ${activeTab === 'projects' ? 'bg-qatari hover:bg-qatari-light' : 'border-qatari text-qatari hover:bg-qatari/10'}`}
        ...
        {activeTab === 'sectors' && (
          <div className="bg-white rounded-xl p-8 shadow-md">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
              <div className="flex flex-col items-start text-left border border-qatari rounded-lg p-6">
          ...
          <div className="bg-white rounded-xl p-8 shadow-md">
            <div className="space-y-6">
              <div className="border-l-4 border-qatari pl-4 py-2">
                ...
                <p className="text-gray-600 text-xl">Tax-free environment and 100% foreign ownership in specialized industrial and logistics hubs</p>
              </div>

              <div className="border-l-4 border-qatari pl-4 py-2">
                <h3 className="text-xl font-semibold">Lusail City Development</h3>
                <p className="text-gray-600 text-xl">Futuristic smart city with commercial, residential, and entertainment districts</p>
              </div>

              <div className="border-l-4 border-qatari pl-4 py-2">
                <h3 className="text-xl font-semibold">Hamad Port Expansion</h3>
                <p className="text-gray-600 text-xl">Major trade hub connecting Qatar to global shipping routes and facilitating import/export</p>
              </div>
            </div>
          </div>
        )}
